...
$fields = array('utm_source', 'utm_medium', 'utm_term', 'utm_content', 'utm_campaign', 'gclid', 'fbclid', '_gl');
...
if(count($fieldsFoundUTMS) > 0) {
    function utms_carry_pages() {
		wp_enqueue_script( 'utms-carry', plugins_url( './utms-carry.js' , __FILE__ ), [], '1.2' );
    }
