...
require_once WJ_MULTILINGUAL_DIR . 'includes/menu-locations.php';
...
require_once WJ_MULTILINGUAL_DIR . 'includes/acf-locale-fields.php';
...
require_once WJ_MULTILINGUAL_DIR . 'includes/admin-language-column.php';
